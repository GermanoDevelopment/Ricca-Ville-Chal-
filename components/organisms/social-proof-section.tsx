    ...
    <section className="py-16 lg:py-24 bg-gradient-to-br from-cream-50 to-sand-50">
      <div className="container mx-auto px-4">
        ...
        <div className="text-center mb-12 lg:mb-16">
          <SectionTitle className="text-terracotta-600 mb-4">O que nossos hóspedes dizem</SectionTitle>
          <Text size="lg" className="text-wood-700 max-w-2xl mx-auto">
            Experiências reais de quem já se hospedou no Ricca Ville Chalé. Confira os relatos e avaliações dos nossos
            queridos hóspedes.
          </Text>
        </div>
        ...
        <div className="mt-12 lg:mt-16 grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
          <div className="space-y-2">
            <div className="text-3xl lg:text-4xl font-bold text-terracotta-600">98%</div>
            <Text className="text-wood-600">Satisfação dos Hóspedes</Text>
          </div>
          <div className="space-y-2">
            <div className="text-3xl lg:text-4xl font-bold text-azure-600">150+</div>
            <Text className="text-wood-600">Avaliações Positivas</Text>
          </div>
          <div className="space-y-2">
            <div className="text-3xl lg:text-4xl font-bold text-sunflower-600">4.9</div>
